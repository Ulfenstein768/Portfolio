    ...
    >
      <div className=" flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <div className="">
          ...
          <div onClick={handleNav} className="md:hidden pl-2">
      ...
      >
        <div
          className={
            nav
              ? " fixed left-0  top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#212121] p-10 ease-in duration-500"
              : "fixed left-[-100%]  top-0 p-10 ease-in duration-500"
          }
        >
          <div>
            <div>
              <div onClick={handleNav} className="grid place-items-end">
          ...
          <div className="py-2 flext flex-col ">
            ...
            <div className="pt-40 ">
              ...
              <div className="flex place-items-end justify-between max-w-[330px] m-auto py-4 pr-5">
